...
require (
	...
	code.cloudfoundry.org/guardian v0.0.0-20250916222349-48a9252a9f3d
...
require (
	code.cloudfoundry.org/commandrunner v0.46.0 // indirect
	code.cloudfoundry.org/lager/v3 v3.48.0 // indirect
